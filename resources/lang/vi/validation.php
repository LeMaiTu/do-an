...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'login_fail' => 'Địa chỉ email hoặc mật khẩu không chính xác.'
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'ten_loi' => 'tên lỗi',
        'nghi_dinh' => 'nghị định',
        'chitiet_nghidinh' => 'chi tiết nghị định',
        'loai_phuongtien' => 'loại phương tiện',
        'muc_phat' => 'mức phạt',

        'nguoivipham' => 'người vi phạm',
        'nguoivipham.cmnd' => 'chứng minh thư',
        'nguoivipham.ho_ten' => 'họ tên',
        'nguoivipham.gioi_tinh' => 'giới tính',
        'nguoivipham.ngay_sinh' => 'ngày sinh',
        'nguoivipham.dia_chi' => 'địa chỉ',
        'nguoivipham.sdt' => 'số điện thoại',
        'nguoivipham.email' => 'email',

        'hosovipham' => 'hồ sơ vi phạm',
        'hosovipham.ma_hoso' => 'mã hồ sơ',
        'hosovipham.ten_hoso' => 'tên hồ sơ',
        'hosovipham.thoigian_lapbienban' => 'thời gian lập biên bản',
        'hosovipham.diadiem_lapbienban' => 'địa điểm lập biên bản',
        'hosovipham.ma_canbo_lapbienban' => 'cán bộ lập biên bản',
        'hosovipham.ngaynhap_hoso' => 'ngày nhập hồ sơ',
        'hosovipham.ngayhen_xuly' => 'ngày hẹn xử lý',
        'hosovipham.thoihan_xuly' => 'thời hạn xử lý',
        'hosovipham.ma_canbo_xuly_hoso' => 'cán bộ xử lý',
        'hosovipham.mo_ta' => 'mô tả',
        ...
        'loivipham.*.ma_loi_vipham' => 'mã lỗi vi phạm',
        'loivipham.*.phat_hanhchinh' => 'phạt hành chính',
        'loivipham.*.mo_ta' => 'mô tả',
    ],
];
