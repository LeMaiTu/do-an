@if(empty($hoso))
    <form class="form-horizontal" id="form_nvp" action="{{ route('cb_hoso.post_tao_hoso') }}"
                        ...
                        <div class="col-md-6">
                            <select id="ma_canbo_lapbienban" name="hosovipham[ma_canbo_lapbienban]" type="text"
                                ...
                                @foreach($canboLapbb as $canbo)
                                    <option
                                        value="{{ $canbo->ma_canbo }}" {{ old('hosovipham.ma_canbo_lapbienban') ==  $canbo->ma_canbo ? 'selected' : ''}}>{{ $canbo->ten_canbo }}</option>
                                    @endforeach
                                    </option>
                            </select>
                ...
                <table class="table  table-responsive table-fixed text-center">
                    ...
                    @if(empty(old('tangvat')))
                        <tr id="tv_0" class="row">
                            ...
                            <td class="col-md-2">
                                <div class="group">
                                    <input id="ngay_tam_giu" name="tangvat[0][ngay_tam_giu]" type="date"
                                           class="form-control @error('tangvat.0.ngay_tam_giu') is-invalid @enderror"
                                           value="{{ date('Y-m-d') }}">
                                    @error('tangvat.0.ngay_tam_giu')
                                    <div class="alert alert-danger d-none">{{ $message }}</div>
                                    @enderror
                                </div>
                            </td>
                    ...
                    @else
                        @foreach(old('tangvat') as $key_tv => $tangvat)
                            <tr id="tv_{{$key_tv}}" class="row">
                                ...
                                <td class="col-md-2">
                                    <div class="group">
                                        <input id="ngay_tam_giu" name="tangvat[{{$key_tv}}][ngay_tam_giu]" type="date"
                                               class="form-control @error('tangvat.'.$key_tv.'.ngay_tam_giu') is-invalid @enderror"
                                               value="{{$tangvat['ngay_tam_giu']}}">
                                        @error('tangvat.'.$key_tv.'.ngay_tam_giu')
                                        <div class="alert alert-danger d-none">{{ $message }}</div>
                                        @enderror
                                    </div>
                                </td>
        ...
        <div class="form-group">
            <div class="text-center">
                <button type="submit" class="btn btn-edit btn-danger pull-right" id="btn_success"
            ...
            $(document).ready(function () {
                $('#btn_add_tv').click(function () {
                    ...
                    let hmtl =
                        ...
                        <td class="col-md-2">
                            <div class="group">
                                <input id="ngay_tam_giu" name="tangvat[${last_tr_id + 1}][ngay_tam_giu]" type="date"
                                       class="form-control @error('tangvat.*.ngay_tam_giu') is-invalid @enderror"
                                       value="{{ date('Y-m-d') }}">
                            </div>
                        </td>
                        <td class="col-md-2">
    ...
    @endpush
@else
    <form class="form-horizontal" id="form_nvp" action="{{ route('cb_hoso.post_chinhsua_hoso', $hoso->ma_hoso) }}"
          enctype="multipart/form-data"
          method="POST">
        @csrf
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <fieldset class="">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="cmnd" name="nguoivipham[cmnd]" type="number" placeholder="Nhập CMND"
                                   value="{{ old('nguoivipham.cmnd', $nguoivipham->cmnd) }}"
                                   class="form-control @error('nguoivipham.cmnd') is-invalid @enderror"
                                   disabled
                            >
                            @error('nguoivipham.cmnd')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="ho_ten" name="nguoivipham[ho_ten]" type="text"
                                   placeholder="Nhập Tên Người Vi Phạm "
                                   class="form-control @error('nguoivipham.ho_ten') is-invalid @enderror"
                                   value="{{ old('nguoivipham.ho_ten') ? old('nguoivipham.ho_ten') : $nguoivipham->ho_ten }}">
                            @error('nguoivipham.ho_ten')
                            <div class="alert alert-danger d-none">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select class="form-control @error('nguoivipham.gioi_tinh') is-invalid @enderror"
                                ...
                                <option value="">Giới tính</option>
                                <option
                                    value="0" {{ old('nguoivipham.gioi_tinh', $nguoivipham->gioi_tinh) == 0 ? 'selected' : '' }}
                                ">Nữ</option>
                                <option
                                    value="1" {{ old('nguoivipham.gioi_tinh', $nguoivipham->gioi_tinh) == 1 ? 'selected' : '' }}>
                                    Nam
                                </option>
                            </select>
                            @error('nguoivipham.gioi_tinh')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="ngay_sinh" name="nguoivipham[ngay_sinh]" type="date" placeholder="Nhập ngày sinh"
                                   class="form-control @error('nguoivipham.ngay_sinh') is-invalid @enderror"
                                   value="{{ old('nguoivipham.ngay_sinh', $nguoivipham->ngay_sinh) }}">
                            @error('nguoivipham.ngay_sinh')
                            <div class="alert alert-danger d-none">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="dia_chi" name="nguoivipham[dia_chi]" type="text"
                                   placeholder="Nhập Địa Chỉ"
                                   class="form-control @error('nguoivipham.dia_chi') is-invalid @enderror"
                                   value="{{ old('nguoivipham.dia_chi', $nguoivipham->ngay_sinh) }}">
                            @error('nguoivipham.dia_chi')
                            <div class="alert alert-danger d-none">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="sdt" name="nguoivipham[sdt]" type="number" placeholder="Nhập Số Điện Thoại "
                                   class="form-control @error('nguoivipham.sdt') is-invalid @enderror"
                                   value="{{ old('nguoivipham.sdt', $nguoivipham->sdt) }}">
                            @error('nguoivipham.sdt')
                            <div class="alert alert-danger d-none">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="email" name="nguoivipham[email]" type="email"
                                   placeholder="Nhập Email"
                                   class="form-control @error('nguoivipham.email') is-invalid @enderror"
                                   value="{{ old('nguoivipham.email', $nguoivipham->email) }}">
                            @error('nguoivipham.email')
                            <div class="alert alert-danger d-none">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="panel-body">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="ma_hoso" name="hosovipham[ma_hoso]" type="text"
                                   placeholder="Nhập Mã Hồ Sơ"
                                   class="form-control @error('hosovipham.ma_hoso') is-invalid @enderror"
                                   value="{{ old('hosovipham.ma_hoso', $hoso->ma_hoso) }}">
                            @error('hosovipham.ma_hoso')
                            <div class="alert alert-danger d-none">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="ten_hoso" name="hosovipham[ten_hoso]" type="text"
                                   placeholder="Nhập Tên Hồ Sơ "
                                   class="form-control @error('hosovipham.ten_hoso') is-invalid @enderror"
                                   value="{{ old('hosovipham.ten_hoso', $hoso->ten_hoso) }}">
                            @error('hosovipham.ten_hoso')
                            <div class="alert alert-danger d-none">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="thoigian_lapbienban" name="hosovipham[thoigian_lapbienban]" type="date"
                                   placeholder="Nhập TG_Lập Biên Bản"
                                   class="form-control @error('hosovipham.thoigian_lapbienban') is-invalid @enderror"
                                   value="{{ old('hosovipham.thoigian_lapbienban', $hoso->thoigian_lapbienban) }}">
                            @error('hosovipham.thoigian_lapbienban')
                            <div class="alert alert-danger d-none">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="diadiem_lapbienban" name="hosovipham[diadiem_lapbienban]" type="text"
                                   placeholder="Nhập Địa Điểm Lập Biên Bản"
                                   class="form-control @error('hosovipham.diadiem_lapbienban') is-invalid @enderror"
                                   value="{{ old('hosovipham.diadiem_lapbienban', $hoso->diadiem_lapbienban) }}">
                            @error('hosovipham.diadiem_lapbienban')
                            <div class="alert alert-danger d-none">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select id="ma_canbo_lapbienban" name="hosovipham[ma_canbo_lapbienban]" type="text"
                                ...
                                @foreach($canboLapbb as $canbo)
                                    <option
                                        value="{{ $canbo->ma_canbo }}" {{ old('hosovipham.ma_canbo_lapbienban', $hoso->ma_canbo_lapbienban) ==  $canbo->ma_canbo ? 'selected' : ''}}>{{ $canbo->ten_canbo }}</option>
                                    @endforeach
                                    </option>
                            </select>
                            @error('hosovipham.ma_canbo_lapbienban')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="ngaynhap_hoso" name="hosovipham[ngaynhap_hoso]" type="date"
                                   placeholder="Nhập Ngày Nhập HS "
                                   class="form-control @error('hosovipham.ngaynhap_hoso') is-invalid @enderror"
                                   value="{{ old('hosovipham.ngaynhap_hoso', $hoso->ngaynhap_hoso) }}">
                            @error('hosovipham.ngaynhap_hoso')
                            <div class="alert alert-danger d-none">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="ngayhen_xuly" name="hosovipham[ngayhen_xuly]" type="date"
                                   placeholder="Nhập Ngày Hẹn Xử Lý HS "
                                   class="form-control @error('hosovipham.ngayhen_xuly') is-invalid @enderror"
                                   value="{{ old('hosovipham.ngayhen_xuly', $hoso->ngayhen_xuly) }}">
                            @error('hosovipham.ngayhen_xuly')
                            <div class="alert alert-danger d-none">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="thoihan_xuly" name="hosovipham[thoihan_xuly]" type="number"
                                   placeholder="Nhập Thời Hạn Xử Lý HS"
                                   class="form-control @error('hosovipham.thoihan_xuly') is-invalid @enderror"
                                   value="{{ old('hosovipham.thoihan_xuly', $hoso->thoihan_xuly) }}">
                            @error('hosovipham.thoihan_xuly')
                            <div class="alert alert-danger d-none">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="ma_canbo_xuly_hoso" name="hosovipham[ma_canbo_xuly_hoso]"
                                   ...
                                   placeholder="Nhập Mã Cán Bộ XLHS "
                                   class="form-control @error('hosovipham.ma_canbo_xuly_hoso') is-invalid @enderror"
                                   value="{{ old('hosovipham.ma_canbo_xuly_hoso', $hoso->thoihan_xuly) }}"
                                   readonly>
                            @error('hosovipham.ma_canbo_xuly_hoso')
                            <div class="alert alert-danger d-none">{{ $message }}</div>
                            @enderror
                    ...
                    <textarea id="mo_ta" name="hosovipham[mo_ta]" type="text" placeholder="Nhập Mô tả" rows="4"
                              cols="50"
                              class="form-control @error('hosovipham.mo_ta') is-invalid @enderror"
                    >{{ old('hosovipham.mo_ta', $hoso->mo_ta) }}</textarea>
                            @error('hosovipham.mo_ta')
                            <div class="alert alert-danger d-none">{{ $message }}</div>
                            @enderror
                        </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table class="table  table-responsive table-fixed text-center">
                    ...
                    <tbody id="res_tv">
                    @foreach(old('tangvat', $danhsachTangvat) as $key_tv => $tangvat)
                        <tr id="tv_{{$key_tv}}" class="row">
                            <td class="col-md-2">
                                <div class="group">
                                    <input id="ma_tangvat" name="tangvat[{{$key_tv}}][ma_tangvat]" type="text "
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table class="table  table-responsive text-center">
                    ...
                    <tbody id="res_loi">
                    @foreach(old('loivipham', $chitietHoso) as $key_loi => $item)
                        <tr id="loi_{{$key_loi}}" class="row">
                            <td class="col-md-3">
                                <div class="group">
                                    <select
